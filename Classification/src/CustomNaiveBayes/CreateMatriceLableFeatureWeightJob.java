...
public class CreateMatriceLableFeatureWeightJob {
	private static final Log logger = LogFactory.getLog(CreateMatriceLableFeatureWeightJob.class);
...
indexInstances.setCombinerClass(VectorSumReducer.class);*/
	...
	Job job = new Job(conf, "CreateMatriceLableFeatureWeightWriter");
	job.setJarByClass(CreateMatriceLableFeatureWeightJob.class);
	job.setMapperClass(CustomModelMapper.class);//IndexInstancesMapper.class);
